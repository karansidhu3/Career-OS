...
- 2–3 projects total (selected by the planner; final canonical names committed after the one-page acceptance pass)
...
- See `backend/app/services/generation_v2.py` for the live planner/writer contracts. `generation.py` remains the template and legacy-generation utility module.
